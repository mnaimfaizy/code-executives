...
*\*Original sizes were for eager-loaded versions. Current sizes include only the page scaffolding, routing logic, and section mapping - actual section content loads on-demand.*
