    ...
    <div className={`bst-visualization ${className}`}>
      ...
      <div className="flex flex-wrap gap-4 mb-6">
        ...
        <div className="flex items-center space-x-2">
          <input
            ...
            className="px-4 py-2 border-2 border-gray-300 rounded-lg text-sm w-36 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent transition-all"
      ...
      <div className="mb-4 p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl border-2 border-blue-200">
        <div className="flex items-center justify-between flex-wrap gap-2">
          <div className="text-sm">
            <span className="font-semibold text-blue-800">BST Property: </span>
            <span
              className={`font-bold text-lg ${isValidBST() ? 'text-green-600' : 'text-red-600'}`}
            >
              {isValidBST() ? '✓ Valid' : '✗ Invalid'}
            </span>
          </div>
          <div className="text-xs text-blue-700 font-medium bg-white/50 px-3 py-1 rounded-full">
      ...
      <div className="mt-4 bg-gradient-to-br from-gray-50 to-white rounded-xl p-4 border border-gray-200">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3 text-xs">
          ...
          <div className="flex items-center space-x-2">
            ...
            <span className="text-gray-700">Insert Path</span>
          </div>
          <div className="flex items-center space-x-2">
          ...
          <div className="flex items-center space-x-2">
            ...
            <span className="text-gray-700">Search Step</span>
          </div>
        </div>
      </div>
      ...
      <div className="mt-4 grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
        ...
        <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl p-4 border-2 border-purple-200 shadow-sm">
          ...
          <div className="text-xs text-purple-700 font-medium mt-1">Height</div>
        </div>
        <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl p-4 border-2 border-green-200 shadow-sm">
          ...
          <div className="text-xs text-green-700 font-medium mt-1">Leaf Nodes</div>
        </div>
