...
export const StackVisualization: React.FC<StackVisualizationProps> = ({
  ...
  return (
    <div className={`bg-white border border-blue-200 rounded-xl p-8 shadow-sm ${className}`}>
      ...
      {/* Stack Visualization */}
      <div className="p-6 bg-gray-50 rounded-lg overflow-hidden">
        <svg viewBox="0 0 500 400" className="w-full h-80" preserveAspectRatio="xMidYMid meet">
          {/* Stack base */}
          <rect x="150" y="360" width="100" height="8" className="fill-gray-600" />
          ...
          <defs>
            <marker id="arrow" markerWidth="10" markerHeight="7" refX="9" refY="3.5" orient="auto">
              <polygon points="0 0, 10 3.5, 0 7" className="fill-orange-600" />
            </marker>
          </defs>
              ...
              <g key={element.id}>
                ...
                <text
                  ...
                  className={`text-lg font-bold transition-colors duration-300 ${
                    isHighlighted ? 'fill-yellow-700' : isTop ? 'fill-green-700' : 'fill-gray-700'
                  }`}
                >
                  {element.value}
                </text>
          ...
          {stack.length === 0 && (
            <text x="200" y="200" textAnchor="middle" className="text-lg fill-gray-400">
              Empty Stack
            </text>
          )}
          ...
          <g>
            ...
            />
            <text x="90" y="80" className="text-xs fill-blue-600 font-medium" textAnchor="middle">
              Growth
            </text>
          </g>
      ...
      <div className="mt-4 p-4 bg-green-50 rounded-lg">
        <h4 className="font-semibold text-green-900 mb-2">Stack Properties:</h4>
        <div className="grid grid-cols-2 gap-4 text-sm">
          <div>
            <strong className="text-green-800">LIFO Principle:</strong>
            <span className="text-green-700 ml-2">Last element added is first to be removed</span>
          </div>
          <div>
            <strong className="text-green-800">Access Pattern:</strong>
            <span className="text-green-700 ml-2">Only top element is accessible</span>
          </div>
          <div>
            <strong className="text-green-800">Push Operation:</strong>
            <span className="text-green-700 ml-2">Add element to top of stack</span>
          </div>
          <div>
            <strong className="text-green-800">Pop Operation:</strong>
            <span className="text-green-700 ml-2">Remove and return top element</span>
          </div>
        </div>
      </div>
    </div>
