    ...
    <div className="bg-white rounded-xl p-6 border border-blue-200 shadow-sm">
      ...
      <div className="mb-6">
        ...
        >
          ...
          {/* Call Stack */}
          <rect x="10" y="80" width="60" height="80" rx="5" fill="#fbbf24" opacity="0.8" />
          <text x="40" y="125" textAnchor="middle" fontSize="9" fill="#92400e" fontWeight="bold">
            Call Stack
          </text>

          {/* Memory Heap */}
          <rect x="80" y="80" width="60" height="80" rx="5" fill="#34d399" opacity="0.8" />
      ...
      <div className="space-y-3">
        <div className="flex items-center space-x-3">
          ...
          <span className="text-sm text-gray-700">
            <strong>Core Responsibility:</strong> Parse, compile, and execute JavaScript code
          </span>
        </div>
        <div className="flex items-center space-x-3">
          <div className="w-3 h-3 bg-green-500 rounded-full"></div>
          <span className="text-sm text-gray-700">
            <strong>JIT Compilation:</strong> Ignition interpreter + TurboFan optimizer
          </span>
        </div>
        <div className="flex items-center space-x-3">
          <div className="w-3 h-3 bg-amber-500 rounded-full"></div>
          <span className="text-sm text-gray-700">
            <strong>Memory Management:</strong> Call Stack + Memory Heap + Garbage Collection
          </span>
        </div>
      </div>
    </div>
  ...
  const RuntimeVisualization = () => (
    <div className="bg-white rounded-xl p-6 border border-purple-200 shadow-sm">
      ...
      <div className="mb-6">
        ...
        >
          {/* V8 Engine (compact) */}
          <rect x="10" y="10" width="100" height="60" rx="5" fill="#3b82f6" opacity="0.8" />
      ...
      <div className="space-y-3">
        <div className="flex items-center space-x-3">
          ...
          <span className="text-sm text-gray-700">
            <strong>Core Responsibility:</strong> Provide complete execution environment
          </span>
        </div>
        <div className="flex items-center space-x-3">
          <div className="w-3 h-3 bg-green-500 rounded-full"></div>
          <span className="text-sm text-gray-700">
            <strong>Environment APIs:</strong> Browser (DOM, fetch) or Node.js (fs, http)
          </span>
        </div>
        <div className="flex items-center space-x-3">
          <div className="w-3 h-3 bg-amber-500 rounded-full"></div>
          <span className="text-sm text-gray-700">
            <strong>Async Coordination:</strong> Event Loop manages queues and execution
          </span>
        </div>
      </div>
    </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
        ...
        <div className="bg-white rounded-xl p-6 border border-blue-200 shadow-sm">
          ...
          <div className="space-y-4 text-gray-700">
            <p>
              A JavaScript engine is the program responsible for{' '}
              <strong>
                translating human-readable JavaScript code into machine-readable instructions
              </strong>{' '}
              that a computer's hardware can execute. The engine acts as a crucial intermediary
              between developer code and the underlying machine.
            </p>
            ...
            <div className="bg-blue-50 border-l-4 border-blue-400 p-4 rounded-r-lg">
              ...
              <ul className="space-y-2 text-blue-700">
                <li>
                  <strong>Call Stack:</strong> LIFO structure managing function execution order
                </li>
                <li>
                  <strong>Memory Heap:</strong> Unstructured pool storing objects and variables
                </li>
                <li>
                  <strong>Parser:</strong> Converts source code to Abstract Syntax Tree (AST)
                </li>
                <li>
                  <strong>JIT Compiler:</strong> Ignition interpreter + TurboFan optimizer
                </li>
              </ul>
            </div>
            ...
            <div className="bg-gray-50 rounded-lg p-4">
              ...
              <div className="space-y-2 text-sm">
                <div className="flex items-center space-x-2">
                  ...
                  <span>
                    <strong>Parsing:</strong> Source Code → Abstract Syntax Tree (AST)
                  </span>
                </div>
                <div className="flex items-center space-x-2">
                  <div className="w-4 h-4 bg-green-500 rounded text-white text-xs flex items-center justify-center font-bold">
                    2
                  </div>
                  <span>
                    <strong>Ignition:</strong> AST → Bytecode (fast startup)
                  </span>
                </div>
                <div className="flex items-center space-x-2">
                  <div className="w-4 h-4 bg-purple-500 rounded text-white text-xs flex items-center justify-center font-bold">
                    3
                  </div>
                  <span>
                    <strong>Profiling:</strong> Identify "hot spots" and gather type feedback
                  </span>
                </div>
                <div className="flex items-center space-x-2">
                  ...
                  <span>
                    <strong>TurboFan:</strong> Bytecode → Optimized Machine Code
                  </span>
                </div>
              </div>
            </div>
            ...
            <p className="text-sm text-gray-600 italic">
              <strong>Key Insight:</strong> The engine implements the ECMAScript specification but
              provides no I/O capabilities - it's purely about code execution.
            </p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl p-6 border border-purple-200 shadow-sm">
          ...
          <div className="space-y-4 text-gray-700">
            <p>
              The JavaScript runtime is the <strong>complete execution environment</strong> that
              hosts the engine and provides critical external functionalities needed for a program
              to interact with the outside world. It's the engine plus everything else needed to run
            ...
            <div className="bg-purple-50 border-l-4 border-purple-400 p-4 rounded-r-lg">
              ...
              <ul className="space-y-2 text-purple-700">
                <li>
                  <strong>JavaScript Engine:</strong> The core execution component (V8,
                  SpiderMonkey, etc.)
                </li>
                <li>
                  <strong>Environment APIs:</strong> Browser (DOM, fetch) or Node.js (fs, http)
                ...
                <li>
                  <strong>Event Loop:</strong> Manages asynchronous operations and queues
                </li>
                <li>
                  <strong>Task Queues:</strong> Macrotask and Microtask queues for callbacks
                </li>
              </ul>
            </div>
            ...
            <p className="text-sm text-gray-600 italic">
              <strong>Key Insight:</strong> The runtime determines what your JavaScript can actually
              do - the engine just executes the core language features.
            </p>
          </div>
        </div>
      </div>
          ...
          <table className="w-full border-collapse">
            <thead>
              <tr className="border-b border-gray-200">
                ...
                <th className="text-left py-3 px-4 font-semibold text-purple-700">
                  JavaScript Runtime
                </th>
              </tr>
            </thead>
            <tbody>
              <tr className="border-b border-gray-100">
                ...
                <td className="py-3 px-4 text-gray-700">
                  Parse, compile, and execute JavaScript code
                </td>
                <td className="py-3 px-4 text-gray-700">
                  Provide complete environment for program execution
                </td>
              </tr>
              <tr className="border-b border-gray-100">
                ...
                <td className="py-3 px-4 text-gray-700">
                  Host-specific (HTML standard, Node.js APIs)
                </td>
              </tr>
              <tr className="border-b border-gray-100">
                <td className="py-3 px-4 font-medium text-gray-900">Key Components</td>
                <td className="py-3 px-4 text-gray-700">
                  Call Stack, Memory Heap, Parser, JIT Compiler
                </td>
              ...
              <tr className="border-b border-gray-100">
                ...
                <td className="py-3 px-4 text-gray-700">
                  Object, Array, Promise, switch statement
                </td>
                <td className="py-3 px-4 text-gray-700">
                  setTimeout(), fetch(), DOM APIs, fs.readFile()
                </td>
              </tr>
              <tr>
      ...
      <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-8 text-white">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <p className="text-blue-100 mb-6 leading-relaxed">
            Understanding the engine-runtime distinction is crucial for debugging performance
            issues, optimizing code execution, and building efficient JavaScript applications. The
            engine handles the language itself, while the runtime provides the environment and APIs
