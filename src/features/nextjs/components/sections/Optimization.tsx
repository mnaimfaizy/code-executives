...
import BundleAnalyzer2D from '../visualizations/2d/BundleAnalyzer2D';
import PerformanceTimeline from '../visualizations/2d/PerformanceTimeline';
import OptimizationDashboard from '../visualizations/2d/OptimizationDashboard';
import ImageOptimizer from '../visualizations/2d/ImageOptimizer';
import BundleViewer from '../visualizations/2d/BundleViewer';
import MetricsTracker from '../visualizations/2d/MetricsTracker';
