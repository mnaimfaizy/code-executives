...
const GlobalInterpreterLock: React.FC = () => {
  ...
  const currentThreading = threadingTabs.find((t) => t.id === activeThreadingTab) ?? threadingTabs[0];
    ...
    <div className="max-w-4xl mx-auto">
      <div className="text-center mb-8">
        ...
        <p className="text-xl text-gray-700 leading-relaxed">
          The GIL is a mutex inside CPython that allows only one thread to execute Python
          bytecode at a time — even on multi-core machines. Understanding it is key to writing
          fast concurrent Python.
        </p>
      </div>
      <StatsGrid
        stats={[
    ...
    <>
      ...
      <ThemeCard>
        <h2 className="text-2xl font-bold text-gray-900 mb-4">
          Interactive GIL Walkthrough
        </h2>
        <p className="text-gray-600 mb-4">
          Step through 8 scenarios to see how the GIL affects thread execution, I/O, multiprocessing,
          asyncio, and the upcoming free-threaded mode.
        </p>
        <GILVisualization />
      </ThemeCard>
      ...
      <ThemeCard>
        ...
        <div className="space-y-4 text-gray-700 leading-relaxed">
          <p>
            ...
            Before any thread can execute Python bytecode, it must acquire the GIL. This means
            only one thread runs Python code at any given moment — even on a 16-core machine.
          </p>
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            ...
            <ul className="space-y-2 text-sm text-blue-800">
              ...
              <li className="flex items-start gap-2">
                <span className="text-blue-500 mt-0.5">•</span>
                <span>
                  <strong>C extension safety:</strong> Thousands of C libraries assume single-threaded
                  access to Python objects. The GIL guarantees that.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-blue-500 mt-0.5">•</span>
                <span>
                  <strong>Simplicity:</strong> Single-threaded programs are never slowed by fine-grained
                  per-object locks.
                </span>
              </li>
            </ul>
      ...
      <ThemeCard>
        ...
        <p className="text-gray-600 mb-4">
          The GIL makes Python threading safe for internal interpreter state, but it does NOT
          make your own code thread-safe. Race conditions still happen with shared mutable data.
        </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-4">
          <div className="bg-red-50 border border-red-200 rounded-lg p-4">
            ...
            <ul className="space-y-1 text-sm text-red-800">
              <li>• Threading is <strong>slower</strong> than sequential</li>
          ...
          <div className="bg-green-50 border border-green-200 rounded-lg p-4">
            ...
            <ul className="space-y-1 text-sm text-green-800">
              <li>• Threading is <strong>faster</strong> (overlapping I/O)</li>
        ...
        <div className="mt-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
          {[
            ...
            >
              ...
              <span className={`inline-block text-xs bg-${item.color}-100 text-${item.color}-700 px-2 py-0.5 rounded-full`}>
                Best for: {item.when}
              </span>
            </div>
          ))}
      ...
      <ThemeCard>
        ...
        <div className="space-y-4 text-gray-700 leading-relaxed">
          <p>
            ...
            build that removes the GIL entirely. Threads can now execute Python bytecode truly
          ...
          <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
            ...
            <ul className="space-y-2 text-sm text-purple-800">
              <li className="flex items-start gap-2">
                ...
                <span>Install via <code className="bg-purple-100 px-1 rounded">python3.13t</code> (the &ldquo;t&rdquo; suffix)</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-purple-500 mt-0.5">•</span>
                <span>Reference counting replaced with biased reference counting + deferred RC</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-purple-500 mt-0.5">•</span>
              ...
              <li className="flex items-start gap-2">
                <span className="text-purple-500 mt-0.5">•</span>
                <span>C extensions need updates — check with <code className="bg-purple-100 px-1 rounded">sys._is_gil_enabled()</code></span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-purple-500 mt-0.5">•</span>
                <span>Expected to become the default in Python 3.16+ after a transition period</span>
              </li>
            </ul>
          </div>
        </div>
            ...
            {[
              {
                ...
                answers: [
                  { label: 'CPU-bound', arrow: 'Use multiprocessing or ProcessPoolExecutor', color: 'blue' },
      ...
      <ThemeCard>
        ...
        <div className="space-y-3 text-xs text-gray-700">
          ...
          <div>
            ...
            <p>
              Only for CPU-bound work. I/O-bound threads overlap waiting time effectively.
            </p>
          </div>
          <div>
            <p className="font-medium text-red-700 mb-1">
