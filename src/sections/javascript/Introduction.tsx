          ...
          <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-sm">
            ...
            <div className="space-y-4 text-gray-700 leading-relaxed">
              <p>
                ...
                foundational technology of the World Wide Web, operating in concert with HTML and
                CSS to create rich, interactive user experiences.
              </p>
              <p>
                While HTML provides the structure and CSS the style, JavaScript supplies the
                <strong> dynamic functionality and behavior</strong> that modern web users expect,
                such as animated image carousels, responsive menus, and dynamic content changes.
              </p>
              <div className="bg-blue-50 border-l-4 border-blue-400 p-4 rounded-r-lg">
                <p className="text-blue-800">
                  <strong>Modern Reality:</strong> Contemporary engines employ Just-in-Time (JIT)
                  compilation, combining the speed of interpretation with performance optimizations
                  to execute code with remarkable efficiency.
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    Historically, JavaScript ran exclusively within web browsers to make static
                    webpages dynamic, responding to user events and modifying webpage structure in
                    real-time.
                  </p>
                </div>
              </div>
          ...
          <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-sm top-4">
            ...
            <div className="space-y-3">
              <button
                ...
                className="w-full text-left p-4 rounded-lg border border-amber-200 bg-amber-50 hover:bg-amber-100 transition-colors group"
              >
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-amber-600 mt-1">
                      From 10-day creation to global dominance
                    </p>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-blue-600 mt-1">
                      Single-threaded with concurrency magic
                    </p>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-purple-600 mt-1">
                      V8, Call Stack, Memory Heap & more
                    </p>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-green-600 mt-1">
                      The master orchestrator of async behavior
                    </p>
                  </div>
