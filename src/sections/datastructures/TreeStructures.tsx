    ...
    <div className="max-w-7xl mx-auto p-6 space-y-12">
      ...
      <div className="text-center space-y-4">
        ...
        <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
          Hierarchical data structures that organize data in a tree-like format with parent-child
          relationships. Perfect for representing hierarchical data and enabling efficient search
          operations.
        </p>
      </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700">
            ...
            <div className="space-y-4">
              <p className="text-gray-700 dark:text-gray-300">
                Trees are hierarchical data structures consisting of nodes connected by edges. Each
                tree has a single root node and every other node has exactly one parent.
              </p>
          ...
          <div className="bg-gradient-to-br from-green-50 to-blue-50 dark:from-green-900/20 dark:to-blue-900/20 rounded-xl p-6">
            ...
            <ul className="space-y-2 text-sm text-gray-700 dark:text-gray-300">
              <li className="flex items-start">
                ...
                <span>
                  <strong>Hierarchical representation:</strong> Natural for file systems, org charts
                </span>
              </li>
              <li className="flex items-start">
                <ArrowRight className="w-4 h-4 mr-2 mt-0.5 text-blue-600 flex-shrink-0" />
                <span>
                  <strong>Efficient searching:</strong> O(log n) in balanced trees
                </span>
              </li>
              <li className="flex items-start">
                <ArrowRight className="w-4 h-4 mr-2 mt-0.5 text-purple-600 flex-shrink-0" />
                <span>
                  <strong>Dynamic size:</strong> Can grow and shrink as needed
                </span>
              </li>
              <li className="flex items-start">
                <ArrowRight className="w-4 h-4 mr-2 mt-0.5 text-orange-600 flex-shrink-0" />
                <span>
                  <strong>Ordered data:</strong> Binary search trees maintain sorted order
                </span>
              </li>
            </ul>
          </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700">
            ...
            <div className="min-h-[400px]">
              ...
              {activeDemo === 'avl' && <AVLTreeVisualization />}
              {activeDemo === 'rb' && <RedBlackTreeVisualization />}
              {activeDemo === 'heap' && <HeapVisualization />}
              {activeDemo === 'btree' && <BTreeVisualization degree={3} />}
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700">
            <div className="flex items-center mb-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Ordered binary tree for fast searching
                </p>
              </div>
            </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl p-8 shadow-sm border border-gray-200 dark:border-gray-700">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="space-y-3">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">
              Directory structures where folders contain subfolders and files, representing
          ...
          <div className="space-y-3">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">
              B-trees and B+ trees used in database systems for efficient data retrieval and range
              queries.
            </p>
          </div>
          ...
          <div className="space-y-3">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">
              Abstract syntax trees (AST) used in compilers and calculators to represent and
          ...
          <div>
            ...
            <div className="space-y-3 text-sm text-gray-700 dark:text-gray-300">
              ...
              <div className="flex items-center">
                ...
                <span>
                  <strong>Highly Unbalanced:</strong> Degrades to linear search
                </span>
              </div>
            </div>
          </div>
