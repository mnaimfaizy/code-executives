...
const GraphStructures: React.FC = () => {
  const [activeDemo, setActiveDemo] = useState<'representation' | 'bfs' | 'dfs' | 'dijkstra' | 'mst'>('representation');
    ...
    <div className="max-w-7xl mx-auto p-6 space-y-12">
      ...
      <div className="text-center space-y-4">
        ...
        <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
          Complex network structures that model relationships between entities.
          Perfect for representing social networks, maps, dependencies, and countless real-world connections.
        </p>
      </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700">
            ...
            <div className="space-y-4">
              <p className="text-gray-700 dark:text-gray-300">
                Graphs are collections of vertices (nodes) connected by edges (links). 
                They're incredibly versatile structures that can model virtually any relationship.
              </p>
          ...
          <div className="bg-gradient-to-br from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 rounded-xl p-6">
            ...
            <ul className="space-y-2 text-sm text-gray-700 dark:text-gray-300">
              <li className="flex items-start">
                ...
                <span><strong>Relationship modeling:</strong> Social networks, dependencies, connections</span>
              </li>
              <li className="flex items-start">
                <ArrowRight className="w-4 h-4 mr-2 mt-0.5 text-green-600 flex-shrink-0" />
                <span><strong>Path finding:</strong> GPS navigation, network routing</span>
              </li>
              <li className="flex items-start">
                <ArrowRight className="w-4 h-4 mr-2 mt-0.5 text-purple-600 flex-shrink-0" />
                <span><strong>Optimization:</strong> Resource allocation, scheduling</span>
              </li>
              <li className="flex items-start">
                <ArrowRight className="w-4 h-4 mr-2 mt-0.5 text-orange-600 flex-shrink-0" />
                <span><strong>Analysis:</strong> Network analysis, recommendation systems</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700">
            ...
            <div className="min-h-[400px]">
              {activeDemo === 'representation' && <GraphVisualization directed={false} weighted={false} />}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700">
            <div className="flex items-center mb-4">
              ...
              <div>
                <h3 className="text-xl font-bold text-gray-900 dark:text-white">Undirected Graph</h3>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700">
            <div className="flex items-center mb-4">
              ...
              <div>
                <h3 className="text-xl font-bold text-gray-900 dark:text-white">Cyclic vs Acyclic</h3>
            ...
            <div className="space-y-3">
              <ul className="text-sm text-gray-600 dark:text-gray-400 space-y-1">
                <li>• <strong>Acyclic:</strong> Trees, DAGs, hierarchies</li>
                <li>• <strong>Cyclic:</strong> Social networks, circuits</li>
      ...
      <div className="bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-xl p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="bg-white dark:bg-gray-800 rounded-lg p-4">
            <h3 className="font-semibold text-gray-900 dark:text-white mb-2">Breadth-First Search</h3>
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">Level-by-level exploration</p>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg p-4">
            <h3 className="font-semibold text-gray-900 dark:text-white mb-2">Dijkstra's Algorithm</h3>
...
C 1 0 0`}
              ...
              <div className="space-y-1">
                <div className="flex items-center">
                  ...
                  <span><strong>Pros:</strong> O(1) edge lookup, simple implementation</span>
                </div>
                <div className="flex items-center">
                  <div className="w-3 h-3 bg-red-500 rounded-full mr-2"></div>
                  <span><strong>Cons:</strong> O(V²) space, slow for sparse graphs</span>
                </div>
              </div>
            </div>
          </div>
...
C: [A]`}
              ...
              <div className="space-y-1">
                <div className="flex items-center">
                  <div className="w-3 h-3 bg-green-500 rounded-full mr-2"></div>
                  <span><strong>Pros:</strong> O(V + E) space, efficient for sparse graphs</span>
                </div>
                <div className="flex items-center">
                  <div className="w-3 h-3 bg-red-500 rounded-full mr-2"></div>
                  <span><strong>Cons:</strong> O(V) edge lookup in worst case</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="bg-gradient-to-r from-orange-50 to-red-50 dark:from-orange-900/20 dark:to-red-900/20 rounded-xl p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-3">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">
              Platforms like Facebook and LinkedIn model user relationships as graphs,
              enabling friend suggestions, influence analysis, and community detection.
            </p>
          </div>
          ...
          <div className="space-y-3">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">
              Package managers and build systems use directed acyclic graphs (DAGs)
              to resolve dependencies and determine installation/compilation order.
            </p>
          </div>
        </div>
      </div>
