...
const PerformanceAnalyzer: React.FC<PerformanceAnalyzerProps> = ({
  ...
  const getComplexityInfo = (complexity: ComplexityClass) => {
    ...
    > = {
      ...
      'O(n³)': {
        color: 'text-red-700 bg-red-200 dark:bg-red-900 dark:text-red-300',
      ...
      'O(n!)': {
        color: 'text-red-800 bg-red-200 dark:bg-red-900 dark:text-red-300',
      ...
      'O(w)': {
        color: 'text-cyan-600 bg-cyan-100 dark:bg-cyan-900 dark:text-cyan-400',
    ...
    <div className={`space-y-6 ${className}`}>
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-2">
          ...
          <span className="font-medium text-gray-900 dark:text-white">Performance Analysis</span>
        </div>
        <button
            ...
            return (
              <div
                ...
                className={`p-4 rounded-lg border-2 transition-colors ${
                  isSelected
                    ? `border-${data.color}-500 bg-${data.color}-50 dark:bg-${data.color}-900/20`
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-lg border border-gray-200 dark:border-gray-700">
          ...
          <div className="space-y-4">
            {/* Complexity Badge */}
            <div className="flex items-center justify-between">
              <span className="text-sm text-gray-600 dark:text-gray-400">Algorithm Complexity</span>
              <span
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <div className="h-20 bg-gray-100 dark:bg-gray-700 rounded flex items-end justify-around px-2">
      ...
      <div className="bg-white dark:bg-gray-800 p-6 rounded-lg border border-gray-200 dark:border-gray-700">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <div className="text-center">
            ...
            <div className="text-sm text-gray-600 dark:text-gray-400">Avg Memory (MB)</div>
          </div>
