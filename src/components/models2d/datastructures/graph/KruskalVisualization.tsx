...
const KruskalVisualization: React.FC<KruskalVisualizationProps> = ({
  className = ""
}) => {
  ...
  const initializeGraph = useCallback(() => {
    ...
    const initialEdges: MSTEdge[] = [
      { id: 'AB', source: 'A', target: 'B', weight: 4, selected: false, rejected: false, highlighted: false, processed: false },
      { id: 'AC', source: 'A', target: 'C', weight: 6, selected: false, rejected: false, highlighted: false, processed: false },
      { id: 'AF', source: 'A', target: 'F', weight: 2, selected: false, rejected: false, highlighted: false, processed: false },
      { id: 'BC', source: 'B', target: 'C', weight: 3, selected: false, rejected: false, highlighted: false, processed: false },
      { id: 'BE', source: 'B', target: 'E', weight: 7, selected: false, rejected: false, highlighted: false, processed: false },
      { id: 'CD', source: 'C', target: 'D', weight: 5, selected: false, rejected: false, highlighted: false, processed: false },
      { id: 'CE', source: 'C', target: 'E', weight: 8, selected: false, rejected: false, highlighted: false, processed: false },
      { id: 'DE', source: 'D', target: 'E', weight: 2, selected: false, rejected: false, highlighted: false, processed: false },
      { id: 'EF', source: 'E', target: 'F', weight: 9, selected: false, rejected: false, highlighted: false, processed: false },
      { id: 'FD', source: 'F', target: 'D', weight: 1, selected: false, rejected: false, highlighted: false, processed: false },
    ];
  ...
  const union = useCallback((nodeId1: string, nodeId2: string, nodes: MSTNode[]): MSTNode[] => {
  ...
  const updateUnionFindSets = useCallback((nodes: MSTNode[]) => {
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center space-x-6">
          ...
          <div className="text-sm">
            ...
            <span className="ml-1 text-teal-600 dark:text-teal-400">{mstEdges.length}/{nodes.length - 1}</span>
          </div>
          <div className="text-sm">
